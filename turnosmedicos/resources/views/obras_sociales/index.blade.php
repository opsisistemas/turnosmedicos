                        ...
                        <tbody>
                            @foreach ($obras_sociales as $obra_social)
                                <tr>
                                    ...
                                    <td>
                                        <!-- TRIGGER THE MODAL WITH A BUTTON -->
                                        {!! Form::button('Editar <i class="fa fa-pencil"></i>', ['class' => 'btn btn-success btn-edit-obra_social', 'type' => 'submit', 'data-id' => $obra_social->id,  'data-toggle' => 'modal', 'data-target' => '#editModal']) !!}                                            
                                    </td>
                                    <!-- Task Delete Button -->
                                    <td>
                                        {!! Form::open([
